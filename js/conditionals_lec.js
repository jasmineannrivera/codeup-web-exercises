...
// var isAdmin = true;
// if (isAdmin) {
//     //display special navbar;
// } else {
//     //displau normal navbar;
// }
...
// //TODO Together: Write an if/else if/else statement that alerts "It's snowing!" if weather is equal
// // to "snowing", alerts "It's raining" if weather is equal to "raining", alerts "have a nice day" for all other cases
// var weather = "raining";
//
// if (weather === "snowing") {
//     alert("It's snowing!");
...
//TODO: Write a function that accepts a string that is a traffic light color as an input. When this function is called,
 ...
 function trafficLight(color) {
    var color = prompt("What is the color of the traffic light?").toLowerCase();
    if (color === "green") {
        alert("go girl!");
        ...
        alert("you aren't at a light are you");
    }
